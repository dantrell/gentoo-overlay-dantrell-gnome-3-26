...
IUSE="+bluetooth browser-extension deprecated-background elogind +ibus +networkmanager nsplugin sassc systemd vanilla-gc vanilla-motd vanilla-screen wayland"
...
src_prepare() {
	...
	eapply "${FILESDIR}"/${PN}-3.26.2-dnd-nullify-dragactor-after-weve-destroyed-it-and-avoid-invalid-access.patch
